import { Actor, AnimatedSprite, AnimationSequence, AnimationState, BoxBody, CircleBody, FilledBox, FilledCircle, Goodie, Hero, ImageSprite, JetLagGameConfig, KeyCodes, ManualMovement, MusicComponent, Scene, Sensor, TextSprite, TimedEvent, initializeAndLaunch, stage } from "../jetlag";
...
function createPopupMenu() {
  ...
  menuContent.innerText = "Instructions: \n Maintain grades, energy, and health! \n\n  *Eat at Rathbone to gain energy. \n\n  *Study at Linderman for knowledge. \n \n  *Sleep in your dorm for health. \n\nEnergy decreases constantly throughout the game, and if it falls to 0 you will lose health. \nIf health falls to 0 that is game over. Make sure to stay on top of your work too!";
  menu.appendChild(menuContent);

  const closeOut =
    document.createElement('button');
  closeOut.innerText = 'close';
  closeOut.onclick = () => {
    document.body.removeChild(menu);
  };
  menu.appendChild(closeOut);
